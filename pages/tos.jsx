  ...
  return (
    <div>
     <h2 className="mt-4 text-white font-bold text-3xl">Terms of Services</h2>
      <p className="text-sm text-white/30 mb-1">Last Update: 03/08/2023 🆕️</p>
...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://top.gg/bot/924325576095973426/vote">Lysoline</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
